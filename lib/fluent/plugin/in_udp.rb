...
module Fluent
  class UdpInput < SocketUtil::BaseInput
    ...
    desc "SO_RCVBUF"
    config_param :so_rcvbuf, :integer, default: nil
    ...
    def listen(callback)
      ...
      SocketUtil::UdpHandler.new(@usock, log, @message_length_limit, callback, !!@source_hostname_key, @remove_newline, @so_rcvbuf)
    end
  end
end
