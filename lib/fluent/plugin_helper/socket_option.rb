...
module Fluent
  module PluginHelper
    module SocketOption
      ...
      def socket_option_validate!(protocol, resolve_name: nil, linger_timeout: nil, recv_timeout: nil, send_timeout: nil, recv_buffer: nil)
      ...
      def socket_option_set(sock, resolve_name: nil, nonblock: false, linger_timeout: nil, recv_timeout: nil, send_timeout: nil, recv_buffer: nil)
        unless resolve_name.nil?
        ...
        if recv_buffer
          socket_option_set_one(sock, :SO_RCVBUF, recv_buffer.to_i)
        end
        sock
      end
